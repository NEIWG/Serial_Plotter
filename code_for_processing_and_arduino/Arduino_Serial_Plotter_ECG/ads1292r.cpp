...
{ 
  ...
  ads1292_Reg_Write(ADS1292_REG_CONFIG1, 0b00000110); 		//Set sampling rate to 8000 SPS OY 8/3/2018
  delay(10);
  ...
  delay(10);
  //ads1292_Reg_Write(ADS1292_REG_CH1SET, 0b01010000);	//Ch 1 enabled, gain 8, connected to electrode in OY 
  //8/3/2018
   //ads1292_Reg_Write(ADS1292_REG_CH1SET, 0b0000000);	//Ch 1 enabled, gain 6, connected to electrode in OY 
  
  ads1292_Reg_Write(ADS1292_REG_CH1SET, 0b0101000);	//Ch 1 enabled, gain 6, connected to electrode in OY 
  ...
  //OY 8/3/2018
  delay(10);
    //ads1292_Reg_Write(ADS1292_REG_LOFFSENS, 0b01000000);		//LOFF settings: all disabled
	ads1292_Reg_Write(ADS1292_REG_LOFFSTAT, 0b01000000);		//LOFF settings: all disabled
